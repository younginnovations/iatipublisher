...
return [
    'defaults' => [
        ...
        'label_class' => 'flex control-label py-4 px-6 font-bold text-sm leading-relaxed rounded-tl-lg rounded-tr-lg border-spring-50 border-t border-r border-l items-center',
        'field_class' => 'form-control',
        'field_error_class' => '',
        'help_block_class' => 'help-block help-text',
        'error_class' => 'text-danger error',
