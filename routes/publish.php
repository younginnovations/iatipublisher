...
Route::group([], static function () {
    Route::get('activities/detect-change', [BulkPublishingController::class, 'detectChange'])->middleware('auth');
    ...
    /* This is used for polling to see if validating against Validator is finished or not. */
    ...
    /* This is used for polling to see if publishing finished or not. */
