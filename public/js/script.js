  ...
  \***********************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        (0, jquery_1['default'])(document).ready(function () {
          ...
          (0, jquery_1['default'])('.add_to_collection').on(
            'click',
            function (e) {
              e.preventDefault();
              var container = (0, jquery_1['default'])('.collection-container');
              var count = (0, jquery_1['default'])('.form-child-body').length;
              var proto = container
                .data('prototype')
                .replace(/__NAME__/g, count);
              (0, jquery_1['default'])('.form-child-body')
                .last()
                .after((0, jquery_1['default'])(proto).unwrap());
            }
          );
        });
