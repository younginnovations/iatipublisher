            ...
            (0, jquery_1['default'])('body').on(
              ...
              function (e) {
                if (e.target.id !== 'nav-list' && e.target.id !== 'hamburger') {
                  (0, jquery_1['default'])('#nav-list').removeClass(
                    'nav-active'
                  );
                  (0, jquery_1['default'])('#hamburger').removeClass('active');
                  (0, jquery_1['default'])('body').removeClass(
                    'overflow-hidden'
                  );
                }
              }
