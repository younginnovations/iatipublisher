        ...
        var FormBuilder =
          ...
          (function () {
            ...
            FormBuilder.prototype.addForm = function (ev) {
              ...
              var count = (0, jquery_1['default'])(target).attr('child_count')
                ? parseInt(
                    (0, jquery_1['default'])(target).attr('child_count')
                  ) + 1
                : (0, jquery_1['default'])('.form-child-body').length + 1;
              var proto = container
                .data('prototype')
                .replace(/__NAME__/g, count);
              (0, jquery_1['default'])('.form-child-body')
                .last()
                .after((0, jquery_1['default'])(proto));
              (0, jquery_1['default'])('.add_to_collection').attr(
                'child_count',
                count
              );
            }; // delete collection
            ...
            FormBuilder.prototype.deleteForm = function (ev) {
              ev.preventDefault();
              var target = ev.target;
              var collectionLength = (0, jquery_1['default'])(
                '.form-child-body'
              ).length;
              var count = (0, jquery_1['default'])(target).attr('child_count')
                ? parseInt(
