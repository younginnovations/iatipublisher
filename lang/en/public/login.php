...
return [
    ...
    'join_now_section'=> [
        ...
        'my_organisation_has_registered_text'=> 'Use this option if your organisation is already registered as an IATI Publisher on the <a href="XXXXXXXXXXXXXXXXXXXXXXXXXXXXX" target="_blank">IATI Registry</a>',
    ...
    'password_changed_section' => [
        ...
        'use_new_password' => 'Please use your new password to login again.',
    ]
];
?>