...
return [
    ...
    'default_currency'    => [
        ...
        'help'        => "If you do not set your default currency, you have to choose and select currency manually for all the financial transactions."
    ],
    'default_language'    => [
        'label'       => "Default Values",
        ...
        'help'        => 'If you do not set your default language, you have to choose and select language for all the narrative text in activity and organisation.',
    ],
    'default_hierarchy'   => [
        ...
        'help'        => "If hierarchy is not reported then 1 is assumed. If multiple levels are reported then, to avoid double counting, financial transactions should only be reported at the lowest hierarchical level. "
    ],
    'budget_not_provided' => [
    ...
    'humanitarian'        => [
        ...
        'help'        => "If not selected, it will be set to 'Yes' in all the activities."
    ],
