...
return [
    ...
    'a_flag_indicating_that_the_reporting_organisation_of_this_activity'   => 'A flag indicating that the reporting organisation of this activity is acting as a secondary reporter. A secondary reporter is one that reproduces data on the activities of an organisation for which it is not directly responsible.',
    ...
    'select_the_type_that_best_describes_the_organisation'                 => '<div class="space-y-1.5"> Select the type that best describes the organisation publishing the data.<a target="_blank" href="https://iatistandard.org/en/iati-standard/203/codelists/organisationtype/">Information on all organisation types.</a></div>',
    'are_you_reproducing_the_data_reported_by_another_organisation'        => '<div class="space-y-1.5"> Are you reproducing the data reported by another organisation? If so, your organisation is a ‘secondary reporter’ and you should select \'<b>Yes</b>\’. If you are reporting your own organisation’s data, select ‘<b>No</b>’.<br><br>Please note: you are <b>not</b> a secondary reporter if your organisation is officially assigned as a proxy to report IATI data on behalf of another organisation. </div>',
    'your_email_address_has_not_been_verified'                             => 'Your email address has not been verified. <span class="resend-verification text-bluecoral cursor-pointer hover:text-spring-50 underline transition-all duration-[400ms]">Resend Verification email</span>',
