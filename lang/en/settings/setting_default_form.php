...
return [
    ...
    'select_language'                                                                  => 'Select language from dropdown',
    ...
    'default_flow_type_level'                                                          => 'Default Flow Type',
    'default_flow_type_name'                                                           => 'default_flow_type',
    ...
    'if_selected_then_default_flow_type_will_be_automatically_populated_in_activity'   => 'If selected, then default flow type will be automatically populated in activity when created.',
    'default_finance_type_level'                                                       => 'Default Finance Type',
    'default_finance_type_name'                                                        => 'default-finance-type',
    'the_type_of_finance'                                                              => 'The type of finance (e.g. grant, loan, debt relief, etc). This the default value for all transactions in the activity report; it can be overridden by individual transactions. <a target=\'_blank\' href=\'https://iatistandard.org/en/iati-standard/203/activity-standard/iati-activities/iati-activity/default-finance-type/\'>For more information</a>',
    'select_default_finance_type'                                                      => 'Select Default Finance Type here',
    ...
    'default_aid_type_name'                                                            => 'default-aid-type',
    ...
    'select_default_aid_type'                                                          => 'Select Default Aid Type here',
    'if_selected_then_default_aid_type_will_be_automatically_populated_in_activity'    => 'If selected, then default aid type will be automatically populated in activity when created. Also, Vocabulary type "OECD DAC" will be chosen by default.',
    'default_tied_status'                                                              => 'Default Tied Status',
    'default_tied_status_name'                                                         => 'default-tied-status',
    ...
    'select_default_tied'                                                              => 'Select Default Tied Status here',
    'if_selected_then_default_tied_status_will_be_automatically_populated_in_activity' => 'If selected, then default tied status will be automatically populated in activity when created.',
