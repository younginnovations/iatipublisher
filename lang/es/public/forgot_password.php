...
return [
    'reset_page'          => [
        'subheading'        => 'es_ Please enter your email address. We will send you a link to reset your password.',
        'email_placeholder' => 'es_ Enter your email address',
        'button'            => 'es_ Send password reset link',
    ],
    'confirm_page'        => [
        'subheading' => 'es_ An email has been sent with further instructions - please check your inbox.',
    ],
    'reset_password_page' => [
