...
return [
    // Commons
    'commons'             => [
      'next_step'               => 'ES__ Next Step',
      'go_back'                 => 'ES__ Go Back',
      'already_have_an_account' => 'ES__ Already have an account?',
      'sign_in'                 => 'ES__ Sign In.',
    ],
    'not_registered_page' => [
      'heading'             => 'ES__ Create IATI Publisher Account and IATI Registry Account',
      'start_journey'       => 'ES__ Start your IATI publishing journey by creating accounts in both IATI Publisher and the IATI Registry',
      'step_count_out_of_5' => 'ES__ Step :count out of 5',
      'register_section'    => [
          // 1st Form
          'heading_one'                                  => 'ES__ Publisher Information',
          'mandatory_fields'                             => 'ES__ Mandatory fields',
          'publisher_information_description'            => 'ES__ This information will be used to register your organisation as an IATI publisher',
          'publisher_information_hover_text'             => 'ES__ We refer to organisations who publish IATI data as \'Publishers\'. Before publishing data, all organisations need their own \'Publisher Account\' on the IATI Registry (iatiregistry.org). Enter your organisation\'s data here and we\'ll create your organisation\'s Publisher Account for you. These details will also be saved here in IATI Publisher.',
          'publisher_name'                               => 'ES__ Publisher Name',
          'publisher_name_placeholder'                   => 'ES__ Type your organisation name here',
          'publisher_name_hover_text'                    => 'ES__ The name of your organisation publishing the data.',
          'publisher_id'                                 => 'ES__ Publisher ID',
          'publisher_id_placeholder'                     => 'ES__ Type your publisher ID here',
          'publisher_id_hover_text'                      => 'ES__ Provide a unique ID for your organisation. It must be at least two characters long and use lower case letters. You can include letters, numbers and also - (dash) and _ (underscore). Where possible use a short abbreviation of your organisation\'s name, for example: \'nef_mali\' for Near East Foundation Mali.',
          'country'                                      => 'ES__ Country',
          'country_placeholder'                          => 'ES__ Select a country',
          'country_hover_text'                           => 'ES__ Add the location of your organisation.',
          'organisation_registration_agency'             => 'ES__ Organisation Registration Agency',
          'organisation_registration_agency_placeholder' => 'ES__ Select an Organisation Registration Agency',
          'organisation_registration_agency_hover_text'  => 'ES__ Select the agency in your country where your organisation is registered. If you do not know this information please email <a href=\'mailto:support@iatistandard.org\' target=\'_blank\'>support@iatistandard.org</a>',
          'registration_number'                          => 'ES__ Registration Number',
          'registration_number_placeholder'              => 'ES__ Type your registration number here',
          'registration_number_hover_text'               => 'ES__ Provide the registration number for your organisation that has been provided by organisation registration agency. If you do not know this please email <a href=\'mailto:support@iatistandard.org\' target=\'_blank\'>support@iatistandard.org</a>.',
          'registration_number_help_text'                => 'ES__ E.g. 123456',
          'identifier'                                   => 'ES__ IATI Organisation Identifier',
          'identifier_hover_text'                        => 'ES__ The Organisation Identifier is a unique code for your organisation. This is genereated from the Organisation Registration Agency and Registration Number. For more information read:  <a href="http://iatistandard.org/en/guidance/preparing-organisation/organisation-account/how-to-create-your-iati-organisation-identifier/" target="_blank">How to create your IATI organisation identifier.</a>',
          'identifier_help_text'                         => 'ES__ This is autogenerated, please make sure to fill the above fields correctly.',
          'organisation_type'                            => 'ES__ Organisation Type',
          'organisation_type_placeholder'                => 'ES__ Select an organisation type',
          'organisation_type_hover_text'                 => 'ES__ Select the type that best describes your organisation.  <a href="https://iatistandard.org/en/iati-standard/203/codelists/organisationtype/" target="_blank"> Read more on Organisation types.</a>',
          'data_licence'                                 => 'ES__ Data Licence',
