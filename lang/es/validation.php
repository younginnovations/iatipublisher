...
return [
    ...
    */
    ...
    'accepted'             => 'ES__ The :attribute must be accepted.',
    'accepted_if'          => 'ES__ The :attribute must be accepted when :other is :value.',
    'active_url'           => 'ES__ The :attribute is not a valid URL.',
    'after'                => 'ES__ The :attribute must be a date after :date.',
    'after_or_equal'       => 'ES__ The :attribute must be a date after or equal to :date.',
    'alpha'                => 'ES__ The :attribute must only contain letters.',
    'alpha_dash'           => 'ES__ The :attribute must only contain letters, numbers, dashes and underscores.',
    'alpha_num'            => 'ES__ The :attribute must only contain letters and numbers.',
    'array'                => 'ES__ The :attribute must be an array.',
    'before'               => 'ES__ The :attribute must be a date before :date.',
    'before_or_equal'      => 'ES__ The :attribute must be a date before or equal to :date.',
    'between'              => [
        'numeric' => 'ES__ The :attribute must be between :min and :max.',
        'file'    => 'ES__ The :attribute must be between :min and :max kilobytes.',
        'string'  => 'ES__ The :attribute must be between :min and :max characters.',
        'array'   => 'ES__ The :attribute must have between :min and :max items.',
    ],
    'boolean'              => 'ES__ The :attribute field must be true or false.',
    'confirmed'            => 'ES__ The :attribute confirmation does not match.',
    'current_password'     => 'ES__ The password is incorrect.',
    'date'                 => 'ES__ The :attribute is not a valid date.',
    'date_equals'          => 'ES__ The :attribute must be a date equal to :date.',
    'date_format'          => 'ES__ The :attribute does not match the format :format.',
    'declined'             => 'ES__ The :attribute must be declined.',
    'declined_if'          => 'ES__ The :attribute must be declined when :other is :value.',
    'different'            => 'ES__ The :attribute and :other must be different.',
    'digits'               => 'ES__ The :attribute must be :digits digits.',
    'digits_between'       => 'ES__ The :attribute must be between :min and :max digits.',
    'dimensions'           => 'ES__ The :attribute has invalid image dimensions.',
    'distinct'             => 'ES__ The :attribute field has a duplicate value.',
    'email'                => 'ES__ The :attribute must be a valid email address.',
    'ends_with'            => 'ES__ The :attribute must end with one of the following: :values.',
    'enum'                 => 'ES__ The selected :attribute is invalid.',
    'exists'               => 'ES__ The selected :attribute is invalid.',
    'file'                 => 'ES__ The :attribute must be a file.',
    'filled'               => 'ES__ The :attribute field must have a value.',
    'gt'                   => [
        'numeric' => 'ES__ The :attribute must be greater than :value.',
        'file'    => 'ES__ The :attribute must be greater than :value kilobytes.',
        'string'  => 'ES__ The :attribute must be greater than :value characters.',
        'array'   => 'ES__ The :attribute must have more than :value items.',
    ],
    'gte'                  => [
        'numeric' => 'ES__ The :attribute must be greater than or equal to :value.',
        'file'    => 'ES__ The :attribute must be greater than or equal to :value kilobytes.',
        'string'  => 'ES__ The :attribute must be greater than or equal to :value characters.',
        'array'   => 'ES__ The :attribute must have :value items or more.',
    ],
    'image'                => 'ES__ The :attribute must be an image.',
    'in'                   => 'ES__ The selected :attribute is invalid.',
    'in_array'             => 'ES__ The :attribute field does not exist in :other.',
