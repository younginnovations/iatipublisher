...
return array (
  'organisation_identifier_label' => 'fr_ organisation-identifier',
  ...
  'organisation_identifier_attributes_organization_country_label' => 'fr_ Country',
  ...
  'organisation_identifier_attributes_organization_registration_agency_hover_text' => 'fr_ Select an agency that your organisation is registered with. If you need help, please email: support@iatistandard.org',
  'organisation_identifier_attributes_registration_number_label' => 'fr_ Registration Number',
  'organisation_identifier_attributes_registration_number_placeholder' => 'fr_ for e.g. 123456',
  ...
  'name_sub_elements_narrative_label' => 'fr_ narrative',
  'name_sub_elements_narrative_hover_text' => 'fr_ Enter the organisation\'s name. This can be repeated in multiple languages.',
  'name_sub_elements_narrative_attributes_lang_label' => 'fr_ language',
  'name_sub_elements_narrative_attributes_lang_placeholder' => 'fr_ Select language',
  'name_sub_elements_narrative_attributes_lang_help_text' => 'fr_ If no language is selected, your default language is assumed.',
  'reporting_org_label' => 'fr_ reporting organisation',
  ...
  'reporting_org_attributes_ref_placeholder' => 'fr_ Type reference',
  ...
  'reporting_org_attributes_type_placeholder' => 'fr_ Select type',
  ...
  'reporting_org_attributes_secondary_reporter_placeholder' => 'fr_ Select secondary-reporter',
  ...
  'reporting_org_sub_elements_narrative_placeholder' => 'fr_ Type name',
  ...
  'total_budget_label' => 'fr_ total budget',
  ...
  'total_budget_attributes_status_label' => 'fr_ status',
  'total_budget_attributes_status_hover_text' => 'fr_ Select a status that best describes this budget:<br><br>(1) <b>indicative</b> - a non-binding estimate for the described budget.<br><br>(2) <b>committed</b> - a binding agreement for the described budget.<br><br>If no status is selected, the budget is assumed to be indicative.',
  'total_budget_sub_elements_period_start_label' => 'fr_ period-start',
  'total_budget_sub_elements_period_start_hover_text' => 'fr_ Enter the start date of the budget period.',
  'total_budget_sub_elements_period_start_attributes_date_label' => 'fr_ date',
  'total_budget_sub_elements_period_start_attributes_date_placeholder' => 'fr_ YYYY-MM-DD',
  'total_budget_sub_elements_period_end_label' => 'fr_ period-end',
  ...
  'total_budget_sub_elements_value_label' => 'fr_ value',
  'total_budget_sub_elements_value_hover_text' => 'fr_ The total value of the organisation\'s budget for this period.',
  'total_budget_sub_elements_value_attributes_amount_placeholder' => 'fr_ Type value here',
  'total_budget_sub_elements_value_attributes_currency_label' => 'fr_ currency',
  'total_budget_sub_elements_value_attributes_currency_placeholder' => 'fr_ Select currency',
  'total_budget_sub_elements_value_attributes_currency_help_text' => 'fr_ If no currency is selected, your default currency is assumed.',
  'total_budget_sub_elements_value_attributes_value_date_label' => 'fr_ value-date',
  'total_budget_sub_elements_value_attributes_value_date_hover_text' => 'fr_ The date used to determine the exchange rate for currency conversions.',
  'total_budget_sub_elements_budget_line_label' => 'fr_ budget line',
  ...
  'total_budget_sub_elements_budget_line_sub_elements_narrative_placeholder' => 'fr_ Type narrative',
  'total_budget_sub_elements_budget_line_sub_elements_narrative_hover_text' => 'fr_ Provide a description for this budget line.',
  'recipient_org_budget_label' => 'fr_ recipient organisation budget',
  ...
  'recipient_org_budget_attributes_status_placeholder' => 'fr_ Select status',
  'recipient_org_budget_sub_elements_recipient_org_label' => 'fr_ recipient organisation',
  'recipient_org_budget_sub_elements_recipient_org_hover_text' => 'fr_ Provide information about the organisation that will receive the funds.',
  ...
  'recipient_org_budget_sub_elements_recipient_org_sub_elements_narrative_hover_text' => 'fr_ Enter the name of the organisation. This can be repeated in multiple languages.',
  ...
  'recipient_region_budget_label' => 'fr_ recipient region budget',
  ...
  'recipient_region_budget_sub_elements_recipient_region_label' => 'fr_ recipient region',
  ...
  'recipient_region_budget_sub_elements_recipient_region_attributes_vocabulary_label' => 'fr_ vocabulary',
  'recipient_region_budget_sub_elements_recipient_region_attributes_vocabulary_placeholder' => 'fr_ Select vocabulary',
  ...
  'recipient_region_budget_sub_elements_recipient_region_attributes_oecd_region_code_label' => 'fr_ code',
  'recipient_region_budget_sub_elements_recipient_region_attributes_oecd_region_code_placeholder' => 'fr_ Select code',
  ...
  'recipient_region_budget_sub_elements_recipient_region_attributes_vocabulary-uri_label' => 'fr_ vocabulary-uri',
  'recipient_region_budget_sub_elements_recipient_region_attributes_vocabulary-uri_placeholder' => 'fr_ Type vocabulary-uri',
  'recipient_region_budget_sub_elements_recipient_region_attributes_vocabulary-uri_hover_text' => 'fr_ If you have selected the vocabulary ‘99 - Reporting Organisation\', provide the URI where this internal list is defined.',
  'recipient_region_budget_sub_elements_recipient_region_sub_elements_narrative_hover_text' => 'fr_ Add an optional name or description of the region benefitting from the activity.',
  ...
  'recipient_country_budget_label' => 'fr_ recipient country budget',
  ...
  'recipient_country_budget_sub_elements_recipient_country_label' => 'fr_ recipient country',
  ...
  'recipient_country_budget_sub_elements_recipient_country_sub_elements_narrative_hover_text' => 'fr_ Add an optional name or description of the country benefitting from the activity.',
  ...
  'total_expenditure_label' => 'fr_ total expenditure',
  ...
  'total_expenditure_sub_elements_expense_line_label' => 'fr_ expense line',
  ...
  'document_link_attributes_url_placeholder' => 'fr_ Select url',
  ...
  'document_link_sub_elements_description_label' => 'fr_ Description',
  ...
  'document_link_sub_elements_language_label' => 'fr_ Language',
  'document_link_sub_elements_language_hover_text' => 'fr_ Select the language that the document is written in. This can be repeated to describe multilingual documents.',
