...
return [
    ...
    'publish_selected'                                    => 'fr_ Publish Selected ( :count )',
    'activity_couldnt_be_published_because'               => 'fr_ Activity couldn’t be published because',
    'you_can_only_publish_up_to_100_activities_at_a_time' => 'fr_ You can only publish up to 100 activities at a time.',
    'please_remove_activity_from_selection_to_publish'    => 'fr_ Please remove :count activity from selection to publish.',
    'please_remove_activities_from_selection_to_publish'  => 'fr_ Please remove :count activities from selection to publish.',
];
