...
return [
    ...
    */
    ...
    'confirmed'            => 'FR_Language The :attribute confirmation does not match.',
    ...
    'email'                => 'FR_Language The :attribute must be a valid email address.',
    ...
    'max'                  => [
        ...
        'string'  => 'FR_Language The :attribute must not be greater than :max characters.',
    ...
    'min'                  => [
        ...
        'string'  => 'FR_Language The :attribute must be at least :min characters.',
    ...
    'required'             => 'FR_language The :attribute field is required.',
    ...
    'string'               => 'FR_Language The :attribute must be a string.',
    ...
    */
    ...
    'string'                                    => 'FR_Language :attribute should be string',
    ...
    'not_in_spam_emails' => 'FR_Language This email has been flagged as spam and cannot be used.',
    /*
    |--------------------------------------------------------------------------
    | Custom Validation Attributes
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'logged_in_verify' => 'FR_Language User must be logged in to verify email.',
];
