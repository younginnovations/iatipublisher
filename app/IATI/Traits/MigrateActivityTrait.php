...
trait MigrateActivityTrait
{
     ...
     * @throws \JsonException
     */
    public function getActivityCountryBudgetItemsData($aidstreamOrganization, $aidstreamActivity): ?array
    {
     ...
     * @throws \JsonException
     */
    public function getBudgetItemsData($budgetItems, $aidstreamOrganization, $aidstreamActivity): array
    {
        $newBudgetItems = [];
