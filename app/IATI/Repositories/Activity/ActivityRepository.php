...
class ActivityRepository extends Repository
{
    ...
    {
        return $this->model->whereIn('id', $activityIds)->where('org_id', auth()->user()->organization->id)->with(['transactions', 'results', 'organization.settings'])->orderBy('updated_at', 'desc')->get();
    }
