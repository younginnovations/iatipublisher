...
class DateController extends Controller
{
    ...
    public function edit(int $id): View|RedirectResponse
    {
        try {
            ...
            $translatedData = trans('activity_detail/date_controller.error_has_occurred_while_rendering_activity_date_form');
    ...
    public function update(DateRequest $request, $id): JsonResponse|RedirectResponse
    {
        try {
            ...
            if (!$this->dateService->update($id, $activityDate)) {
                $translatedData = trans('activity_detail/date_controller.error_has_occurred_while_updating_activity_date');

                return redirect()->route('admin.activity.show', $id)->with('error', $translatedData);
            }
            $translatedData = trans('activity_detail/date_controller.activity_date_updated_successfully');
