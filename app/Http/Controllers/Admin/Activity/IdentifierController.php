...
class IdentifierController extends Controller
{
    ...
    public function edit(int $id): View|RedirectResponse
    {
        try {
            ...
            $translatedData = trans('activity_detail/identifier_controller.error_has_occurred_while_opening_activity_title_form');
    ...
    public function update(IdentifierRequest $request, $id): JsonResponse|RedirectResponse
    {
        try {
            ...
            if (!$this->identifierService->update($id, $request->except(['_method', '_token']))) {
                $translatedData = trans('activity_detail/identifier_controller.error_has_occurred_while_updating_iati_identifier');
            ...
            $translatedData = trans('activity_detail/identifier_controller.iati_identifier_updated_successfully');
            ...
            return response()->json(
                ['success' => false, 'error' => $translatedData]
            );
        }
    }
}
