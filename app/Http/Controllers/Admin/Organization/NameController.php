...
class NameController extends Controller
{
    ...
    public function edit(): View|RedirectResponse
    {
        try {
            ...
            $form = $this->baseFormCreator->editForm($model, $element['name']);
            $status = $organization->name_element_completed ?? false;
            $data = ['core'=> $element['name']['criteria'] ?? false, 'status'=> $organization->name_element_completed ?? false, 'title'=> $element['name']['label'], 'name'=>'tinametle'];
