...
class GeneralController extends Controller
{
    ...
    public function getFileExtension(Request $request): JsonResponse
    {
        try {
            ...
            $extensions = array_flip(json_decode(file_get_contents(app_path("Data/$currentLocale/Activity/Extension.json")), true, 512, JSON_THROW_ON_ERROR));
            $additionalExtensions = json_decode(file_get_contents(app_path("Data/$currentLocale/Activity/AdditionalExtension.json")), true, 512, JSON_THROW_ON_ERROR);
