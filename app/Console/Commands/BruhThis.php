...
//    ) {
//        parent::__construct();
//        $this->activities = Activity::whereIn('id',[1420,1417,1342,1340,1341,1339,1343,1344,1345,1346,1347,1348,1349,1350,1351,1352,1353,1354,1355,1356,1357,1358,1359,1360,1361])->with(['transactions', 'results.indicators.periods'])->get();
//    }
//
//
//    /**
...
//
//                foreach ($parallelResponses as $response) {
//                    if ($response['state'] === 'fulfilled') {
//                        $validatorResponses[$activityId] = $response['value']->getBody()->getContents();
//                    } else {
...
//
//                if ($response['state'] === 'fulfilled') {
//                    $validatorResponses[] = $response['value']->getBody()->getContents();
//                } else {
