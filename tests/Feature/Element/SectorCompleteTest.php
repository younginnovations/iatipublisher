...
class SectorCompleteTest extends ElementCompleteTest
{
    ...
    /**
     * Sector element complete with all filled.
     *
     * @return void
     * @throws \JsonException
     */
    ...
    /**
     * Sector element complete test for 'text' attribute.
     *
     * @return void
     * @throws \JsonException
     */
    public function test_sector_type_element_complete_with_empty_vocabulary_and_field_is_condisdered_text(): void
    {
        $sector_typeData = json_decode(
            '[{"sector_vocabulary":"","text":"11110-aaa","percentage":"100","narrative":[{"narrative":"narrative test","language":"en"}]}]',
            true,
            512,
            JSON_THROW_ON_ERROR
        );
