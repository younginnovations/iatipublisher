...
class ResultCompleteTest extends ElementCompleteTest
{
    ...
    public function test_period_element_complete(): void
    {
        $actualData = json_decode(
            '[{"period_start":[{"date":"2022-08-02"}],"period_end":[{"date":"2022-08-20"}],"target":[{"value":"123456756","comment":[{"narrative":[{"narrative":"dgfthygju","language":"ab"}]}],"dimension":[{"name":null,"value":null}],"document_link":[{"url":"https://www.coo.com","format":"asd","title":[{"narrative":[{"narrative":"fghm","language":"ae"}]}],"description":[{"narrative":[{"narrative":"asd","language":"ab"}]}],"category":[{"code":123}],"language":[{"language":null}],"document_date":[{"date":"2022-02-22"}]}],"location":[{"reference":null}]}],"actual":[{"value":"123456","comment":[{"narrative":[{"narrative":"bj","language":"aa"}]}],"dimension":[{"name":"cfgvhnb","value":"23456"}],"document_link":[{"url":"https:\/\/stage.iatipublisher.yipl.com.np\/activities\/10\/result\/2\/indicator\/create","format":"application\/1d-interleaved-parityfec","title":[{"narrative":[{"narrative":"jj","language":"ab"}]}],"description":[{"narrative":[{"narrative":"bbh","language":"aa"}]}],"category":[{"code":"A02"}],"language":[{"language":"ab"}],"document_date":[{"date":"2022-08-03"}]}],"location":[{"reference":null}]}]}]',
            true,
            512,
            JSON_THROW_ON_ERROR
        );
