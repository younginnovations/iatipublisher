<?php if ($showLabel && $showField) : ?>
    ...
    <div class="form-field-label">
        <?php if ($showLabel && $options['label'] !== false && $options['label_show'] && $options['required']) : ?>
            <?= Html::decode(Form::customLabel($name, $options['label'] . '<span class="text-salmon-40"> *</span>')) ?>
        <?php endif; ?>
        ...
        <?php if ($options['hover_block'] !== false) : ?>
            <div class="help"><button><svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 14" class="text-sm">
                ...
                <div class="help__text right-0 w-72"><span class="font-bold text-bluecoral"> <?= $options['hover_block']['title'] ?></span>
                    <p><?= $options['hover_block']['text'] ?></p>
                </div>
            </div>
        <?php endif; ?>
    </div>
