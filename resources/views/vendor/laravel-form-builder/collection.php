...
if ($showLabel && $showField): ?>
    ...
    <?php if (isset($options['options']['dynamic_wrapper'])): ?>
                                  ...
                                  <div class="title-container w-full">
                                      <div class="flex justify-between items-center w-full">
                                          <div class="flex space-x-2 items-center">
                                            ' . $label . ($label_indicator === 'required_icon' ? '<span class="required-icon px-1">*</span>' : '') . '
                                            ' . $help_text . '
                                            ' . $hover_text . ($label_indicator === 'optional_text' ? getOptionalTextDom() : '') .
                                            '</div>
                                            ' . $collapsable_button . '
                                        </div>
                                        ' . $errorSection . '
        ...
        <?php if (strtolower($options['label']) === "narrative"): ?>
            <section class="collection_error px-6 py-2">
