...
<?php if ($showLabel && $options['label'] !== false && $options['label_show'] && strtolower($options['label']) !== "narrative"): ?>
     <?php
      $label = isset($options['options']['data']['label'])? trans($options['options']['data']['label']): trans($options['label']);
      $help_text = $options['options']['help_text'] !== '' ?
          '<div>
              <p class="help-button text-xs text-n-40 hover:text-spring-50 font-normal ml-1.5 cursor-pointer inline-block"><?php echo(trans("common.help")) ?></p>
              <div class="help-button-content hidden">
                  <p class="font-bold text-bluecoral">
                      ' . $label . '
                  </p>
                  <div class="space-y-1.5">
                  ' . trans($options['options']['help_text']) . '
                  </div>
              </div>
          </div>' : '';
      $hover_text = $options['options']['hover_text'] !== '' ?
          '<div class="help ml-1.5 font-normal">
             ...
             <div class="left-0 help__text w-72">
                 ...
                 <p>' . trans($options['options']['hover_text']) . '</p>
             </div>
          </div>' : '';
