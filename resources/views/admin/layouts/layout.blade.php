    ...
    <div class="px-5 xl:px-10 pt-4 pb-[71px]">
      ...
      <div class="activities">
        <aside class="activities__sidebar">
          <div class="rounded-lg bg-white p-6 text-xs leading-relaxed text-n-40">
            ...
            <div class="mb-3 flex justify-between">
              ...
              <hover-text hover-text="You cannot publish an activity until all the mandatory fields have been filled."
                name="" />
            </div>
        ...
        <div class="activities__content">
          <div class="py-[6.06%] px-[6.06%] xl:px-[12%] bg-white max-w-[1000px]">
