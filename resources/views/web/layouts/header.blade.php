  ...
  <header class="grid mx-5 sm:mx-10 xl:mx-24 xl:px-1">
    <nav class="text-xs flex justify-between items-center pt-5 px-10 bg-white rounded-md mt-12 relative z-10">
        ...
        <ul class="nav__list flex space-x-3 pt-10 leading-5">
          ...
          <div class="dropdown relative">
            ...
            <div
              ...
              <a class="bg-bluecoral text-white text-xs py-2 px-5 rounded-sm" href="#">Read more</a>
            </div>
          </div>
          <li class="nav__links"><a href="#">SUPPORT</a></li>
          <ul class="languages absolute bottom-4 left-24 flex justify-center items-center xl:hidden">
            ...
            <li class="nav__links"><a class="nav__active" href="#">EN</a>
            </li>
      ...
      <div class="languages pt-11 xl:block hidden">
        <ul class="nav__list flex justify-center items-center">
          <span class="uppercase pt-5 xl:pt-0 pb-5 mr-2">Language:</span>
          <li class="nav__links"><a class="nav__active" href="#">EN</a></li>
          <li class="nav__links"><a href="#">FR</a></li>
          <li class="nav__links"><a href="#">ES</a></li>
        </ul>
      </div>
