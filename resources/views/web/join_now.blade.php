...
@section('content')
  <section class="main md:flex mx-5 sm:mx-10 xl:mx-24 xl:px-1 mt-10">
    <div
      class="left md:basis-2/4 flex flex-col justify-center items-center bg-bluecoral rounded-r-lg lg:rounded-r-none rounded-l-lg pt-14 lg:pt-44 pb-72 md:pb-16 lg:pb-52 px-7 xl:px-24 text-white">
      <div class="left__container p-10 rounded-lg">
        ...
        <span>Already a member? <a class="text-Turquoise" href="join_now.blade.php">Sign In</a></span>
      </div>
    </div>
    <div
      ...
      <div class="right__container flex flex-col">
        ...
        <div class="right__content flex items-center bg-white mb-6 py-6 px-5 rounded-lg">
          <div>
            <svg width="52" height="52" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="26" cy="26" r="25.25" stroke="#18ACB2" stroke-width="1.5" />
              <path
                ...
                fill="#18ACB2" stroke="#18ACB2" stroke-width=".3" />
              <path
        ...
        <span class="text-sm text-N-N40">Not sure which one to select? <a class="text-bluecoral font-bold"
