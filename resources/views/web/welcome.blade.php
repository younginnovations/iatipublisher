...
@section('content')
  <section class="main md:flex sm:mx-10 xl:mx-24 xl:px-1 mt-7 sm:mt-10">
    <div
      ...
      <div class="left__container p-5 sm:p-10 rounded-lg">
        ...
        <p class="pt-4 sm:pt-6 pb-4 sm:pb-8">Welcome to IATI Publisher. Use this tool to start your IATI publishing
          journey.
          Enter
          your login
    ...
    <div id="right"
      ...
      <div class="right__container flex flex-col">
        <h2 class="text-n-50 font-bold mb-2 text-4xl sm:text-heading-3">Sign In.</h2>
        ...
        <button
          ...
          IN
          <svg class="absolute right-7 group-hover:translate-x-1 hover:fill-white duration-200" width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
