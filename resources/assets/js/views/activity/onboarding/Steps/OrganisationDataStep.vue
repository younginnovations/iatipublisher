          ...
          <div class="border-b border-n-20 py-4">
            <p class="flex items-center font-bold">
              ...
              <span class="ml-1 mr-[10px]">{{
                translatedData['elements.name.reporting_organisation']
              }}</span>
            ...
            <div class="grid grid-cols-2 pt-4">
              ...
              <div class="w-full max-w-[335px]">
                <div class="flex justify-between pb-2">
                  ...
                  <button>
                    <HoverText
                      :name="translatedData['elements.name.reference']"
                      :hover-text="
                        translatedData[
                ...
                <input
                  ...
                  :placeholder="
                    translatedData[
                      'onboarding.organisation_data_step.type_reference'
                    ]
                  "
              ...
              <div class="w-full max-w-[335px]">
                <div class="flex justify-between pb-2">
                  <label for="type" class="text-[14px]">
                    {{ translatedData['elements.name.type'] }}
                    <span class="required-icon"> *</span>
                  </label>
                  <button>
                    <HoverText
                      :name="translatedData['elements.name.type']"
                      :hover-text="
                        translatedData[
                ...
                <Multiselect
                  id="type"
                  class="vue__select"
                  placeholder="translatedData['onboarding.organisation_data_step.select_type']"
                  :searchable="true"
              ...
              <div class="w-full max-w-[335px] pt-6">
                <div class="flex justify-between pb-2">
                  <label for="secondary-reporter" class="text-[14px]">
                    {{ translatedData['elements.name.secondary_reporter'] }}
                  </label>
                  <button>
                    <HoverText
                      position="top-left"
                      :name="translatedData['elements.name.secondary_reporter']"
                      :hover-text="
                        translatedData[
                ...
                <Multiselect
                  ...
                  :placeholder="
                    translatedData[
                      'onboarding.organisation_data_step.select_secondary_reporter'
                    ]
                  "
                  :searchable="true"
...
const contentValues = [
  {
    title: translatedData['elements.name.reference'],
    content:
      translatedData[
  ...
  {
    title: translatedData['elements.name.type'],
    content:
      translatedData[
  ...
  {
    title: translatedData['elements.name.secondary_reporter'],
    content:
      translatedData[
