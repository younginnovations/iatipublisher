<template>
  <div class="bg-paper px-4 pt-4 pb-[71px] xl:px-10">
    <div
      v-if="showSidebar"
    ...
    <aside
      ...
      class="activities__sidebar fixed top-[60px] left-0 z-[100] block h-[calc(100vh_-_60px)] overflow-y-auto bg-eggshell duration-200 lg:hidden"
    >
