      ...
      <section class="rounded bg-white py-4 shadow-textbox sm:py-8">
        ...
        <article class="ounded py-4 px-6 sm:py-6 sm:px-12">
          ...
          <p class="mt-4 text-base">
            ...
            Secretariat and has been developed by Young Innovations, a software
            development firm based in Nepal. IATI Publisher is fully aligned
            with the IATI Standard XML schema and rulesets.
          </p>
        </article>
      </section>
    </div>
