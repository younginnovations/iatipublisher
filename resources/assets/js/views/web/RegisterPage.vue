<template>
  <section class="section mb-7 sm:mx-10 sm:mb-10 md:mb-14 xl:mx-24 xl:px-1">
            ...
            <div class="form__content">
              ...
              <div class="mb-4">
                ...
                <input
                  class="form__input"
                  type="text"
                  placeholder="Select your Organisation Registration Agency"
                />
              </div>
    ...
    <!-- <div>
      <h2>{{ registerForm[`step_${step}`].title }}</h2>
      <div
        v-for="field in registerForm[`step_${step}`].fields"
        :key="field.name"
      >
        ...
        <span class="error" role="alert" v-if="errorData[field.name] != ''">
          {{ errorData[field.name] }}
        </span>
      ...
      <button v-if="step != 1" @click="goToPreviousForm()">Previous</button>
      <button v-if="step != 3" @click="goToNextForm()">Next</button>
    </div> -->
  </section>
</template>
...
export default defineComponent({
  ...
  //   registration_agency: Array<string>,
  // },
