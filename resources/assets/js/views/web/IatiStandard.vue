      ...
      <section class="rounded bg-white py-4 shadow-textbox sm:py-8">
        <article class="py-4 px-6 sm:py-6 sm:px-12">
          <p class="text-base">
            ...
            you through all data fields (which are referred to as ‘elements’) of
            the IATI Standard, offering helpful explanations and links to
            further information and guidance. The IATI Standard requires
        ...
        <article class="py-4 px-6 sm:py-6 sm:px-12">
          ...
          <p class="text-base">
            You will be asked to publish data about your entire organisation.
            This includes basic information about your organisation, such as
