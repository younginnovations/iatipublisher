      ...
      <section class="rounded bg-white py-4 shadow-textbox sm:py-8">
        ...
        <article class="py-4 px-6 sm:py-6 sm:px-12">
          ...
          <p class="mt-4 text-base">
            <a href="https://www.iatiregistry.org/register_publisher/"
              >Publish your Organisation Data</a
            >
          </p>
        </article>
        <article class="py-4 px-6 sm:py-6 sm:px-12">
          <h3 class="text-2xl font-bold text-bluecoral">2. Activity Data</h3>
          <p class="text-base">
        ...
        <article class="py-4 px-6 sm:py-6 sm:px-12">
          ...
          <a class="my-2"> [IATI Organisation Standard data PDF] </a> <br />
          <a class="my-2"> [IATI Activity Standard data PDF] </a>
        </article>
        <article class="py-4 px-6 sm:py-6 sm:px-12">
          <h3 class="text-2xl font-bold text-bluecoral">
