    ...
    <div class="rounded-lg bg-white p-4">
      <div class="mb-4 flex">
        ...
        <div class="icons flex">
          ...
          <hover-text v-if="tooltip" :hover_text="tooltip" class="text-n-40"></hover-text>
        </div>
      </div>
      ...
      <div class="text-sm text-n-50">
          ...
          >
            ...
            <table class="table-head">
              ...
              <tr>
                <td>Narrative</td>
                <td>
                  <div v-for="(narrative, j) in reporting_org.narrative" :key="j">
                    <div class="language">
                      ({{
                        narrative.language
        ...
        <div v-if="title == 'total_budget'">
          ...
          >
            ...
            >
              <div class="bg-n-10 py-2 pl-6 text-left text-xs font-bold">budget line</div>
        ...
        <div v-if="title == 'recipient_org_budget'">
          ...
          >
            ...
            >
              ...
              >
                <tr class="recipient-organisation flex flex-col">
                  <td>
                    {{
                      recipient_org.ref
              ...
              >
                ...
                <table class="table-head recipient-organisation">
                  ...
                  <tr class="flex leading-5">
                    <td class="mb-1 w-[100px] text-n-40">Narrative</td>
                    <td class="flex flex-col">
                      <div v-for="(narrative, k) in budget_line.narrative" :key="k">
        ...
        <div v-if="title == 'recipient_country_budget'">
          ...
          >
            ...
            <span class="mb-1 text-sm"
              >{{ recipient_country_budget.value["0"].amount ?? "Budget Not Available" }}
            ...
            <table class="table-head recipient-organisation">
              ...
              <tr class="flex">
                ...
                <td class="pl-2 leading-5 lg:w-[500px]">
                  <div
                    v-for="(narrative, j) in recipient_country_budget.recipient_country[
                      '0'
                    ].narrative"
                    :key="j"
                  >
            ...
            >
              ...
              >
                ...
                <div class="flex leading-5">
                  <div class="mb-1 text-n-40">Narrative</div>
        ...
        <div v-if="title == 'total_expenditure'">
          ...
          >
            ...
            >
              ...
              <div v-for="(expense_line, j) in total_expenditure.expense_line" :key="j">
                <div class="mt-2 border-b border-b-n-20 pl-6 text-xs">
                  <table>
                    <tr>
                      <td class="mb-1 flex flex-col text-xs font-bold">
                        {{ expense_line.value["0"].amount ?? "Expense Not Available" }}
          ...
          >
            <div>
              <div v-if="document_link.url" class="max-w-[887px] text-sm">
                <a :href="document_link.url" target="_blank">{{ document_link.url }}</a>
              </div>
            ...
            <div class="ml-5">
              ...
              <table>
                <tr>
                  <td>Category</td>
                  <td>
                    <div v-for="(category, i) in document_link.category" :key="i">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    >
                      ...
                      <div v-for="(narrative, j) in recipient_country.narrative" :key="j">
                        <div class="language">
                          ({{
                            narrative.language
                              ? `Language: ${types.languages[narrative.language]} `
