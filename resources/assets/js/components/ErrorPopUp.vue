<template>
  <div>
    <div @click="close" class="fixed inset-0 z-40 bg-black/20"></div>
    <div
      class="fixed top-[50vh] left-1/2 z-50 w-[500px] max-w-[90%] -translate-y-1/2 -translate-x-1/2 rounded-lg bg-white p-8"
    >
